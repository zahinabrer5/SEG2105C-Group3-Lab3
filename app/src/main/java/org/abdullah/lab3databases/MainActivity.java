...
//                Toast.makeText(MainActivity.this, "Add product", Toast.LENGTH_SHORT).show();
        ...
        findBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (product != null) {
                    String price = String.valueOf((int)product.getProductPrice());
                    productPrice.setText(price);
                }

                Toast.makeText(MainActivity.this, "Attempted to find product and filled in the price field for you!", Toast.LENGTH_SHORT).show();
                viewProducts();
            }
        });
...
//                String message = "Deleted product named "+name;
//                if (!dbHandler.deleteProduct(name))
//                    message = "Unable to find product named"+name;
                dbHandler.deleteProduct(name);
                String message = "Attempted to delete product named "+name;
